...
export default new Vuex.Store({
  ...
  actions: {
    ...
    fetchThread ({state, commit}, {id}) {
      console.log('🔥 📄', id)
      return new Promise((resolve, reject) => {
        firebase.database().ref('vue-forum/threads').child(id).once('value', snapshot => {
    ...
    fetchUser ({state, commit}, {id}) {
      console.log('🔥 🙋‍', id)
      return new Promise((resolve, reject) => {
        firebase.database().ref('vue-forum/users').child(id).once('value', snapshot => {
    ...
    fetchPost ({state, commit}, {id}) {
      console.log('🔥 💬‍', id)
      return new Promise((resolve, reject) => {
        firebase.database().ref('vue-forum/posts').child(id).once('value', snapshot => {
